...
Nets have been placed roughly 6 feet above the ground and over the water to prevent the heron from coming above.This does seem to  
...
# General Concept # 
Place motion sensors around the perimeter to a pond to work together. If the sensors are triggered HIGH, send a pulse to acivate a 
12V 120db car alarm. 

# BOM #
Several methods were implementned during the process of this project and may be found in the sketches directory. Materials used for 
different approaches will be listed under their own separate BOM tab. The main design shall be listed first, followed by the wireless, 
RS-485, and CAN approaches, along with alternative parts more suitable for testing and cost. 
...
## RS-485 ##
1. 2x RS-485 transceivers.

## CAN ##
1. 2x CAN transceivers
2. External CAN controller if* your MCU does not have one. 
